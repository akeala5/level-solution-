...
const categoryGroups = [
  {
    group: 'Informatique & High-Tech', icon: Laptop, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Ordinateurs portables',   icon: Laptop,     slug: 'ordinateurs-portables', color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'PC de bureau',            icon: Monitor,    slug: 'pc-bureau',             color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Composants PC',           icon: Cpu,        slug: 'composants',            color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Smartphones & Tablettes', icon: Smartphone, slug: 'smartphones',           color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Stockage & SSD',          icon: HardDrive,  slug: 'stockage',              color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Reseau & Serveurs',       icon: Server,     slug: 'reseau-serveurs',       color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Ecrans & Moniteurs',      icon: Monitor,    slug: 'ecrans',                color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Audio & Casques',         icon: Headphones, slug: 'audio',                 color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Imprimantes & Scanners',  icon: Printer,    slug: 'imprimantes',           color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Cameras & Webcams',       icon: Camera,     slug: 'cameras',               color: 'text-muted',     bg: 'bg-gray-50' },
      { name: 'Claviers & Souris',       icon: Keyboard,   slug: 'claviers-souris',       color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Cables & Adaptateurs',    icon: Cable,      slug: 'cables',                color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Jeux video & Consoles',   icon: Gamepad2,   slug: 'jeux-video',            color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Musique & Instruments',   icon: Music,      slug: 'musique',               color: 'text-muted', bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Mode & Beaute', icon: Shirt, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Vetements Homme',         icon: Shirt,      slug: 'vetements-homme',       color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Vetements Femme',         icon: Shirt,      slug: 'vetements-femme',       color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Vetements Enfants',       icon: Baby,       slug: 'vetements-enfants',     color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Chaussures Homme',        icon: ShoppingBag,slug: 'chaussures-homme',      color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Chaussures Femme',        icon: ShoppingBag,slug: 'chaussures-femme',      color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Sacs & Maroquinerie',     icon: ShoppingBag,slug: 'sacs',                  color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Produits de beaute',      icon: Sparkles,   slug: 'beaute',                color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Parfums & Cosmetiques',   icon: Sparkles,   slug: 'parfums',               color: 'text-muted', bg: 'bg-gray-50' },
      { name: 'Montres & Bijoux',        icon: Gem,        slug: 'montres-bijoux',        color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Lunettes & Optique',      icon: Tag,        slug: 'lunettes',              color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Vehicules & Engins', icon: Car, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Voitures (4 roues)',      icon: Car,        slug: 'voitures',              color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Motos (2 roues)',         icon: Bike,       slug: 'motos',                 color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Tricycles (3 roues)',     icon: Truck,      slug: 'tricycles',             color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Camions & Utilitaires',   icon: Truck,      slug: 'camions',               color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Engins de chantier',      icon: Tractor,    slug: 'engins-chantier',       color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Engins agricoles',        icon: Tractor,    slug: 'engins-agricoles',      color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Bateaux & Pirogues',      icon: Plane,      slug: 'bateaux',               color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Pieces & Accessoires',    icon: Wrench,     slug: 'pieces-vehicules',      color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Maison & Jardin', icon: Home, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Meubles & Decoration',   icon: Sofa,       slug: 'meubles',               color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Electromenager',          icon: Home,       slug: 'electromenager',        color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Cuisine & Arts de table', icon: Utensils,   slug: 'cuisine',               color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Bricolage & Outils',      icon: Hammer,     slug: 'bricolage',             color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Jardinage & Plantes',     icon: Leaf,       slug: 'jardinage',             color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Energie & Solaire',       icon: Sun,        slug: 'energie-solaire',       color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Bebe & Enfants',          icon: Baby,       slug: 'bebe-enfants',          color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Produits menagers',       icon: Package,    slug: 'menage',                color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Alimentation & Agro', icon: Utensils, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Alimentation generale',  icon: ShoppingBag,slug: 'alimentation',          color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Boissons & Jus',          icon: Package,    slug: 'boissons',              color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Epicerie & Condiments',   icon: Utensils,   slug: 'epicerie',              color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Agriculture & Semences',  icon: Leaf,       slug: 'agriculture',           color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Elevage & Betail',        icon: PawPrint,   slug: 'elevage',               color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Peche & Aquaculture',     icon: Fish,       slug: 'peche',                 color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Animaux domestiques',     icon: PawPrint,   slug: 'animaux',               color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Sante & Bien-etre', icon: Stethoscope, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Medicaments & Pharma',    icon: Stethoscope,slug: 'pharmacie',             color: 'text-muted',     bg: 'bg-gray-50' },
      { name: 'Materiel medical',        icon: Stethoscope,slug: 'materiel-medical',      color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Sport & Fitness',         icon: Dumbbell,   slug: 'sport',                 color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Bien-etre & Spa',         icon: Sparkles,   slug: 'bien-etre',             color: 'text-muted',  bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Immobilier & BTP', icon: Building2, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Terrains a vendre',       icon: Building2,  slug: 'terrain',               color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Maisons & Villas',        icon: Home,       slug: 'maisons',               color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Appartements',            icon: Building2,  slug: 'appartements',          color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Location',                icon: Tag,        slug: 'location',              color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Materiaux de construction',icon: Hammer,    slug: 'materiaux',             color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Equipements BTP',         icon: Tractor,    slug: 'equipements-btp',       color: 'text-muted',  bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Services & Emploi', icon: Briefcase, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Offres d emploi',         icon: Briefcase,     slug: 'emploi',             color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Freelance & Missions',    icon: Briefcase,     slug: 'freelance',          color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Formation & Cours',       icon: GraduationCap, slug: 'formation',          color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Services a domicile',     icon: Home,          slug: 'services-domicile',  color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Transport & Livraison',   icon: Truck,         slug: 'transport',          color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Evenementiel',            icon: Music,         slug: 'evenementiel',       color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Tourisme & Voyages',      icon: Plane,         slug: 'tourisme',           color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Loisirs & Culture', icon: Gamepad2, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Jeux video & Consoles',   icon: Gamepad2,   slug: 'jeux-video',            color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Livres & BD',             icon: BookOpen,   slug: 'livres',                color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Musique & Instruments',   icon: Music,      slug: 'musique',               color: 'text-muted', bg: 'bg-gray-50' },
      { name: 'Films & Series',          icon: Camera,     slug: 'films',                 color: 'text-muted',     bg: 'bg-gray-50' },
      { name: 'Art & Artisanat',         icon: Sparkles,   slug: 'art-artisanat',         color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Jouets & Jeux',           icon: Gamepad2,   slug: 'jouets',                color: 'text-muted',  bg: 'bg-gray-50' },
    ],
  },
  {
    group: 'Dons & Echanges', icon: Heart, color: 'text-muted', bg: 'bg-gray-50',
    items: [
      { name: 'Dons & Gratuit',          icon: Heart,      slug: 'dons',                  color: 'text-muted',    bg: 'bg-gray-50' },
      { name: 'Echanges & Troc',         icon: Tag,        slug: 'troc',                  color: 'text-muted',   bg: 'bg-gray-50' },
      { name: 'Antiquites & Collections',icon: Gem,        slug: 'antiquites',            color: 'text-muted',  bg: 'bg-gray-50' },
      { name: 'Divers & Autres',         icon: Package,    slug: 'divers',                color: 'text-muted',    bg: 'bg-gray-50' },
    ],
  },
]
  ...
  return (
    <>
      <header className={cn(
        ...
        scrolled ? 'bg-card shadow-nav' : 'bg-card/95 backdrop-blur-sm'
      )}>
        {/* Top bar */}
